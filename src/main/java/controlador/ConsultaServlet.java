...
// Obtener ID_MASCOTA desde la consulta (necesitamos agregarlo al query)
// Por ahora lo extraemos del objeto Consulta
                        ...
                        htmlEnCurso.append("<button class='btn-accion btn-finalizar' onclick='finalizarConsulta(").append(c.getIdConsulta()).append(")'>");
                        htmlEnCurso.append("<i class='fas fa-check'></i> Finalizar</button>");
