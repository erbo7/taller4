...
import cx.OrdenAnalisisDAO;

@WebServlet("/OrdenAnalisisServlet")
public class OrdenAnalisisServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        OrdenAnalisisDAO dao = new OrdenAnalisisDAO();
        ...
        switch (action) {
            ...
            case "listarOrdenes": {
                try {
                    ...
                    if (ordenes.isEmpty()) {
                        out.print("<div class='alert alert-info'>No hay órdenes de análisis registradas</div>");
                    } else {
                        out.print("<div class='table-responsive'>");
                        out.print("<table class='table table-hover'>");
                        out.print("<thead><tr>");
                        ...
                        for (Map<String, Object> o : ordenes) {
                            ...
                            out.print("<td>" + o.get("tipoAnalisis") + "</td>");
                            ...
                            if (estado.equals("EMITIDA")) {
                                out.print("<button class='btn btn-sm btn-warning me-1' onclick='abrirModalEditar("
                                        + o.get("idOrden") + ", \"" + o.get("tipoAnalisis") + "\", \""
            ...
            case "obtenerTipos": {
                List<Map<String, Object>> tipos = dao.obtenerTiposAnalisis();
                if (tipos.isEmpty()) {
        ...
        switch (action) {
            case "registrar": {
                try {
                    ...
                    int idMascota = Integer.parseInt(request.getParameter("idMascota"));
                    int idTipoAnalisis = Integer.parseInt(request.getParameter("idTipoAnalisis"));
                    ...
                    boolean exito = dao.registrarOrden(idConsulta, idMascota, idVeterinario,
                            idTipoAnalisis, motivo, observaciones);
            ...
            case "actualizar": {
                try {
                    ...
                    boolean exito = dao.editarOrden(idOrden, idTipoAnalisis, motivo, observaciones);
