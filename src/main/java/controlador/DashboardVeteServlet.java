// controlador/DashboardVeteServlet.java
package controlador;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (accion) {
            case "obtenerEstadisticas": {
                ...
                int estudiosPendientes = dao.obtenerEstudiosPendientes(idUsuario);
                int pacientesAtendidos = dao.obtenerPacientesAtendidosMes(idUsuario);

                out.print(citasHoy + "|" + consultasEnCurso + "|" + estudiosPendientes + "|" + pacientesAtendidos);
                break;
            }
