...
<html lang="es">
    <head>
        ...
        <style>
            :root {
                --primary-color: #6ee7b7;   /* verde menta claro */
                --secondary-color: #3b82f6; /* azul suave para contraste */
                --sidebar-width: 250px;
            ...
            .btn-primary-custom.header-button {
                ...
                <div id="module-inicio">
                    ...
                    <div class="stats-grid">
                        ...
                        <div class="stat-card orange">
                            <div class="stat-card-icon">
                                <i class="fas fa-check-circle"></i>  <!-- ⭐ CAMBIO DE ICONO -->
                            </div>
                            <h6>CONSULTAS FINALIZADAS HOY</h6>  <!-- ⭐ CAMBIO DE TEXTO -->
                            <h2 id="statConsultasFinalizadasHoy">0</h2>  <!-- ⭐ CAMBIO DE ID -->
                        </div>
                        ...
                        <div class="col-md-8">
                            <div class="card-custom">
                                <div class="card-custom-header">
                                    ...
                                    <button class="btn-primary-custom header-button" onclick="window.location.href = 'gestionarConsultas.jsp'">
                                        ...
                                        function cargarEstadisticas() {
                                            fetch('DashboardVeteServlet?accion=obtenerEstadisticas')
                                                    ...
                                                    .then(function (respuesta) {
                                                        ...
                                                        animarNumero('statConsultasFinalizadasHoy', parseInt(datos[2]));
